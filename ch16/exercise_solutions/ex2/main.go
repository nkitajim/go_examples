...
func main() {
	...
	sinfo := SmallOrderInfo{}
	fmt.Println("Size of OrderInfo:", unsafe.Sizeof(sinfo))

	fmt.Println("Offset of IsReady:", unsafe.Offsetof(sinfo.IsReady))
	fmt.Println("Offset of OrderNumber:", unsafe.Offsetof(sinfo.OrderNumber))
	fmt.Println("Offset of OrderCode:", unsafe.Offsetof(sinfo.OrderCode))
	fmt.Println("Offset of Amount:", unsafe.Offsetof(sinfo.Amount))
	fmt.Println("Offset of Items:", unsafe.Offsetof(sinfo.Items))
}
